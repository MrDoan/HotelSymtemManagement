...
public class Room {
	...
	@Column(name = "numbers_of_adults")
	private long numOfAdult;

	@Column(name = "numbers_of_children")
	...
	public String toString() {
		return "Room [id=" + id + ", hotelId=" + hotelId + ", roomNumber=" + roomNumber
				+ ", roomName=" + roomName + ", desription=" + desription + ", roomArea=" + roomArea
				+ ", numOfBed=" + numOfBed + ", numOfAdult=" + numOfAdult + ", numOfChildren="
				+ numOfChildren + ", price=" + price + ", imagePath=" + imagePath + ", active="
				+ active + ", createdBy=" + createdBy + ", createdOn=" + createdOn
